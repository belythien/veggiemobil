    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.dish.update', ['dish' => $model]) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-outline-success" href="{{route('admin.dish.index')}}"><i class="fa fa-times-circle"></i> Abbrechen</a>
                </div>
            </div>
        </div>
    </div>
